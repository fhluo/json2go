...
import {useFontSizeStore, useLanguageStore, useRealTimeStore, useValidJSONStore} from "@/lib/store.ts"
...
function App() {
    ...
    let {jsonEditor, goEditor, init: initEditors, generate} = useEditorsStore()
