                ...
                <MenubarSub>
                    ...
                    <MenubarSubContent>
                        <MenubarRadioGroup value={view} onValueChange={(value) => setView(value as View)}>
                            <MenubarRadioItem value={View.JSONAndGo}>{t("view.both", View.JSONAndGo)}</MenubarRadioItem>
                            <MenubarRadioItem value={View.JSONOnly}>
                                {t("view.jsonOnly", View.JSONOnly)}
                            </MenubarRadioItem>
                            <MenubarRadioItem value={View.GoOnly}>{t("view.goOnly", View.GoOnly)}</MenubarRadioItem>
                        </MenubarRadioGroup>
                    </MenubarSubContent>
                </MenubarSub>
                <MenubarSub>
                    ...
                    <MenubarSubContent>
                        <MenubarRadioGroup value={layout} onValueChange={(value) => setLayout(value as Layout)}>
                            ...
                            <MenubarRadioItem value={Layout.TwoRows}>{t("view.rows", Layout.TwoRows)}</MenubarRadioItem>
                        </MenubarRadioGroup>
                    </MenubarSubContent>
                </MenubarSub>
            </MenubarContent>
