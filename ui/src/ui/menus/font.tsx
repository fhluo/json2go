...
export default function Font() {
    ...
    return (
        <MenubarMenu>
            ...
            <MenubarContent>
                <MenubarItem onClick={increase}>{t("font.increase", "Increase size")}</MenubarItem>
                <MenubarItem onClick={decrease}>{t("font.decrease", "Decrease size")}</MenubarItem>
                <MenubarItem onClick={reset}>{t("font.reset", "Reset size")}</MenubarItem>
            </MenubarContent>
        </MenubarMenu>
    );
}
