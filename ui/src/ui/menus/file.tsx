...
export default function File() {
    ...
    return (
        <MenubarMenu>
            ...
            <MenubarContent>
                <MenubarItem onClick={openJSON}>{t("file.openJSON", "Open JSON file")}</MenubarItem>
                <MenubarItem onClick={saveGo}>{t("file.saveGo", "Save Go source file")}</MenubarItem>
                <MenubarSeparator />
                <DialogTrigger
                    render={
                ...
                />
                <MenubarSeparator />
                <MenubarItem onClick={() => void Application.Quit()}>{t("file.exit", "Exit")}</MenubarItem>
            </MenubarContent>
        </MenubarMenu>
    );
}
